  ...
  return (
    <Container sx={containerStyle}>
        ...
        <Typography variant="h1">Bridge Homes, Touch Hearts</Typography>
         <Typography sx={{mt:'20px', mb:'10px'}}>Welcome to Foster Connections, where every match sparks new hope! This platform is dedicated to shelters seeking compassionate fosters and to individuals who are eager to open their homes to pets in need. With our targeted email alerts, shelters can directly reach potential fosters with details of pets urgently requiring care.</Typography>
